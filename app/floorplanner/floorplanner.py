...
#-------------------------------------------#
class Floorplanner(app.Application):
...
#-------------------------------------------#
    def draw(self, parentPanel, subset):
        ...
        for i in xrange(len(subset)):
            panels.append(blockmaker.BlockMaker(parentPanel,dimensions=subset[i].roomSizes,description=subset[i].roomDesc))
        return panels
